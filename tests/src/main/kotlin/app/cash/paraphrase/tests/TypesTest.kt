...
class TypesTest(
  ...
  private val paraphraseResources = when (icuImpl) {
    IcuImpl.Android -> AndroidParaphraseResources
    IcuImpl.Jvm -> ParaphraseResources(dateTimeConverter = JvmDateTimeConverter)
  }

  @Test fun typeNone() {
    val formattedString = getString(paraphraseResources.type_none("Z"))
    assertThat(formattedString).isEqualTo("A Z B")
    val formattedInteger = getString(paraphraseResources.type_none(2))
    assertThat(formattedInteger).isEqualTo("A 2 B")
    val formattedDouble = getString(paraphraseResources.type_none(2.345))
    assertThat(formattedDouble).isEqualTo("A 2.345 B")
    val formattedInstant =
      getString(paraphraseResources.type_none(releaseDateTime.toInstant()))
    assertThat(formattedInstant).isEqualTo("A 2022-03-25T05:23:45Z B")
  }

  @Test fun typeNumber() {
    val formattedInteger = getString(paraphraseResources.type_number(2))
    assertThat(formattedInteger).isEqualTo("A 2 B")
    val formattedDouble = getString(paraphraseResources.type_number(2.345))
    assertThat(formattedDouble).isEqualTo("A 2.345 B")
  }

  @Test fun typeNumberInteger() {
    val formatted = getString(paraphraseResources.type_number_integer(2))
    assertThat(formatted).isEqualTo("A 2 B")
  }

  @Test fun typeNumberCurrency() {
    val formatted = getString(paraphraseResources.type_number_currency(2))
    assertThat(formatted).isEqualTo("A $2.00 B")
  }

  @Test fun typeNumberPercent() {
    val formatted = getString(paraphraseResources.type_number_percent(.2))
    assertThat(formatted).isEqualTo("A 20% B")
  }

  @Test fun typeNumberCustom() {
    val formatted = getString(paraphraseResources.type_number_custom(1234567))
    assertThat(formatted).isEqualTo("A 12,34,567 B")
  }

  @Test fun typeDate() {
    val formatted = getString(paraphraseResources.type_date(releaseDate))
    assertThat(formatted).isEqualTo("A Mar 24, 2022 B")
  }

  @Test fun typeDateShort() {
    val formatted = getString(paraphraseResources.type_date_short(releaseDate))
    assertThat(formatted).isEqualTo("A 3/24/22 B")
  }

  @Test fun typeDateMedium() {
    val formatted = getString(paraphraseResources.type_date_medium(releaseDate))
    assertThat(formatted).isEqualTo("A Mar 24, 2022 B")
  }

  @Test fun typeDateLong() {
    val formatted = getString(paraphraseResources.type_date_long(releaseDate))
    assertThat(formatted).isEqualTo("A March 24, 2022 B")
  }

  @Test fun typeDateFull() {
    val formatted = getString(paraphraseResources.type_date_full(releaseDate))
    assertThat(formatted).isEqualTo("A Thursday, March 24, 2022 B")
  }

  @Test fun typeDatePatternDateTimeZone() {
    val formatted =
      getString(paraphraseResources.type_date_pattern_date_time_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A 3-24, 7PM HST B")
  }

  @Test fun typeDatePatternDateTimeOffset() {
    val formatted = getString(
      paraphraseResources.type_date_pattern_date_time_offset(releaseDateTime.toOffsetDateTime()),
    )
  ...
  @Test fun typeDatePatternDateTime() {
    ...
    val formatted = getString(paraphraseResources.type_date_pattern_date_time(localDateTime))
    assertThat(formatted).isEqualTo("A 3-24 7PM B")
  }

  @Test fun typeDatePatternDateZone() {
    val formatted =
      getString(paraphraseResources.type_date_pattern_date_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A March (HST) B")
  }

  @Test fun typeDatePatternDateOffset() {
    val formatted = getString(
      paraphraseResources.type_date_pattern_date_offset(releaseDateTime.toOffsetDateTime()),
    )
    assertThat(formatted).isEqualTo("A March (-10:00) B")
  }

  @Test fun typeDatePatternDate() {
    val formatted = getString(paraphraseResources.type_date_pattern_date(releaseDate))
    assertThat(formatted).isEqualTo("A 2022-03-24 B")
  }

  @Test fun typeDatePatternTimeZone() {
    val formatted =
      getString(paraphraseResources.type_date_pattern_time_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A 19:23 HST B")
  }

  @Test fun typeDatePatternTimeOffset() {
    val formatted = getString(
      paraphraseResources.type_date_pattern_time_offset(
  ...
  @Test fun typeDatePatternTime() {
    val formatted = getString(paraphraseResources.type_date_pattern_time(releaseTime))
    assertThat(formatted).isEqualTo("A 23 past 7 B")
  }

  @Test fun typeDatePatternZone() {
    val formatted = getString(paraphraseResources.type_date_pattern_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A Hawaii-Aleutian Standard Time B")
  }

  @Test fun typeDatePatternOffset() {
    val formatted = getString(
      paraphraseResources.type_date_pattern_offset(releaseDateTime.offset),
    )
    assertThat(formatted).isEqualTo("A GMT-10:00 B")
  }

  @Test fun typeDatePatternNone() {
    val formatted = getString(paraphraseResources.type_date_pattern_none(null))
    assertThat(formatted).isEqualTo("A What is this for? B")
  }

  @Test fun typeTime() {
    val formatted = getString(paraphraseResources.type_time(releaseTime))
    assertThat(formatted).isEqualTo("A 7:23:45${androidNnbsp}PM B")
  }

  @Test fun typeTimeShort() {
    val formatted = getString(paraphraseResources.type_time_short(releaseTime))
    assertThat(formatted).isEqualTo("A 7:23${androidNnbsp}PM B")
  }

  @Test fun typeTimeMedium() {
    val formatted = getString(paraphraseResources.type_time_medium(releaseTime))
    assertThat(formatted).isEqualTo("A 7:23:45${androidNnbsp}PM B")
  }

  @Test fun typeTimeLong() {
    val formatted = getString(paraphraseResources.type_time_long(releaseDateTime))
    assertThat(formatted).isEqualTo("A 7:23:45${androidNnbsp}PM HST B")
  }

  @Test fun typeTimeFull() {
    val formatted = getString(paraphraseResources.type_time_full(releaseDateTime))
  ...
  @Test fun typeTimePatternDateTimeZone() {
    val formatted =
      getString(paraphraseResources.type_time_pattern_date_time_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A 3-24, 7PM HST B")
  }

  @Test fun typeTimePatternDateTimeOffset() {
    val formatted = getString(
      paraphraseResources.type_time_pattern_date_time_offset(releaseDateTime.toOffsetDateTime()),
    )
  ...
  @Test fun typeTimePatternDateTime() {
    val localDateTime = releaseDateTime.toLocalDateTime()
    val formatted = getString(paraphraseResources.type_time_pattern_date_time(localDateTime))
    assertThat(formatted).isEqualTo("A 3-24 7PM B")
  }

  @Test fun typeTimePatternDateZone() {
    val formatted =
      getString(paraphraseResources.type_time_pattern_date_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A March (HST) B")
  }

  @Test fun typeTimePatternDateOffset() {
    val formatted = getString(
      paraphraseResources.type_time_pattern_date_offset(releaseDateTime.toOffsetDateTime()),
    )
    assertThat(formatted).isEqualTo("A March (-10) B")
  }

  @Test fun typeTimePatternDate() {
    val formatted = getString(paraphraseResources.type_time_pattern_date(releaseDate))
    assertThat(formatted).isEqualTo("A 2022-03-24 B")
  }

  @Test fun typeTimePatternTimeZone() {
    val formatted =
      getString(paraphraseResources.type_time_pattern_time_zone(releaseDateTime))
    assertThat(formatted).isEqualTo("A 19:23 HST B")
  }

  @Test fun typeTimePatternTimeOffset() {
    val formatted = getString(
      paraphraseResources.type_time_pattern_time_offset(
  ...
  @Test fun typeTimePatternTime() {
    val formatted = getString(paraphraseResources.type_time_pattern_time(releaseTime))
  ...
  @Test fun typeTimePatternOffset() {
    val formatted = getString(
      paraphraseResources.type_time_pattern_offset(releaseDateTime.offset),
    )
    assertThat(formatted).isEqualTo("A GMT-10:00 B")
  }

  @Test fun typeTimePatternNone() {
    val formatted = getString(paraphraseResources.type_time_pattern_none(null))
    assertThat(formatted).isEqualTo("A What is this for? B")
  }
  ...
  @Test fun typeTimeWithWinterTimeZone() {
    ...
    val formatted = getString(paraphraseResources.type_time_long(winterDateTime))
  ...
  @Test fun typeTimeWithSummerTimeZone() {
    ...
    val formatted = getString(paraphraseResources.type_time_long(summerDateTime))
    assertThat(formatted).isEqualTo("A 12:00:00${androidNnbsp}PM CDT B")
  }

  @Test fun typeDuration() {
    val formattedSeconds = getString(paraphraseResources.type_duration(3.seconds))
    assertThat(formattedSeconds).isEqualTo("A 3 sec. B")
    val formattedMinutes = getString(paraphraseResources.type_duration(3.minutes + 2.seconds))
    assertThat(formattedMinutes).isEqualTo("A 3:02 B")
    val formattedHours = getString(paraphraseResources.type_duration(3.hours + 2.minutes + 1.seconds))
    assertThat(formattedHours).isEqualTo("A 3:02:01 B")
  }

  @Test fun typeOrdinal() {
    val zero = 0 // Requires an int overload to be invoked
    val formattedZero = getString(paraphraseResources.type_ordinal(zero))
    assertThat(formattedZero).isEqualTo("A 0th B")
    val formattedOne = getString(paraphraseResources.type_ordinal(1))
    assertThat(formattedOne).isEqualTo("A 1st B")
    val formattedTwo = getString(paraphraseResources.type_ordinal(2))
    assertThat(formattedTwo).isEqualTo("A 2nd B")
    val formattedThree = getString(paraphraseResources.type_ordinal(3))
    assertThat(formattedThree).isEqualTo("A 3rd B")
    val formattedFour = getString(paraphraseResources.type_ordinal(4))
    assertThat(formattedFour).isEqualTo("A 4th B")
    val formattedLong = getString(paraphraseResources.type_ordinal(Long.MAX_VALUE))
  ...
  @Test fun typeSpellout() {
    val formattedOnes = getString(paraphraseResources.type_spellout(3))
    assertThat(formattedOnes).isEqualTo("A three B")
    val formattedTens = getString(paraphraseResources.type_spellout(32))
    assertThat(formattedTens).isEqualTo("A thirty-two B")
    val formattedHundreds = getString(paraphraseResources.type_spellout(321))
    assertThat(formattedHundreds).isEqualTo("A three hundred twenty-one B")
  }

  @Test fun typePlural() {
    val formatted0 = getString(paraphraseResources.type_count_plural(0))
    assertThat(formatted0).isEqualTo("A Z B")
    val formatted1 = getString(paraphraseResources.type_count_plural(1))
    assertThat(formatted1).isEqualTo("A Y B")
    val formatted2 = getString(paraphraseResources.type_count_plural(2))
    assertThat(formatted2).isEqualTo("A X B")
  }

  @Test fun typeSelect() {
    val formattedAlpha = getString(paraphraseResources.type_verse_select("alpha"))
    assertThat(formattedAlpha).isEqualTo("A Z B")
    val formattedBeta = getString(paraphraseResources.type_verse_select("beta"))
